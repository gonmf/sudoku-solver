...
each square, mixing in between the detection of impossible states and finished searches, for performance.

Tested with the sample puzzles.txt file (29,071 puzzles) on a 2020 MBP it solves all in 12.03s (0.41ms/puzzle average).
